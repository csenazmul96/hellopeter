<?php /**  * Header functions.  *  * @package Betheme  * @author Muffin group
...
if( ! function_exists( 'mfn_styles' ) )
{
	function mfn_styles() 
	{
		...
		wp_enqueue_style( 'bootstrap',		THEME_URI .'/css/bootstrap.min.css', false, THEME_VERSION, 'all' );	 
		...
		wp_enqueue_style( 'customstyle',		THEME_URI .'/css/customstyle.css', false, THEME_VERSION, 'all' );	
		...
		wp_enqueue_style( 'custom_responsive',		THEME_URI .'/css/custom_responsive.css', false, THEME_VERSION, 'all' );
	}
}
...
if( ! function_exists( 'mfn_scripts' ) )
{
	function mfn_scripts() 
	{
		if( ! is_admin() ){
			...
			wp_enqueue_script( 'popper', 			THEME_URI .'/js/popper.min.js', false, THEME_VERSION, true );
			// wp_enqueue_script( 'meanmenu', 			THEME_URI .'/js/jquery.meanmenu.js', false, THEME_VERSION, true );
			// wp_enqueue_script( 'jqueryui', 			THEME_URI .'/js/jquery-ui.min.js', false, THEME_VERSION, true );
			wp_enqueue_script( 'custom_script', 			THEME_URI .'/js/custom.js', false, THEME_VERSION, true );
